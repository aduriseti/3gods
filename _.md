...
So how effective is this pruning? I added some telemetry to my prolog puzzle to analyze exploration/pruning statistics when solving the full riddle. One thing that surprised me is how few questions we actually explore at each depth level. We don't get anywhere close to exploring all 729 (actually its 365 b/c I use conjugate symmetry to cut down the question space) possible questions:
```txt
